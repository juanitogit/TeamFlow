...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-cloud flex flex-col font-sans text-ink">
      <header className="sticky top-0 z-50 w-full bg-white border-b border-mist shadow-sm">
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-mist pb-safe">
